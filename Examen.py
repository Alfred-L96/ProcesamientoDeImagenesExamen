        ...
        if path.exists(image):
            while path.exists(image):
                ...
                if path.exists(image) != True:
                    cv2.imwrite('C:/Users/santi/Procesamiento de imagenes/Examen1raParcial/'+NombreImagen+n+ExtencionDeImagen,frame)
                    img = cv2.imread('C:/Users/santi/Procesamiento de imagenes/Examen1raParcial/'+NombreImagen+n+ExtencionDeImagen)
                    ...
                    cv2.imwrite('C:/Users/santi/Procesamiento de imagenes/Examen1raParcial/rostroCartun'+n+ExtencionDeImagen,cartoon)
